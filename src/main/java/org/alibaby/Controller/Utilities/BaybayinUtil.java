...
public class BaybayinUtil {
    ...
    Map<String, String> tagalogToBaybayin = new HashMap<>();
    {
    ...
    public static void main(String[] args) {
        BaybayinUtil b = new BaybayinUtil();
        System.out.println(b.translate("tumesting ka aling beybi"));
    }
}